...
| `show-more-suggestions`         | Boolean  | `false`    | Whether to display the suggestions list again when the maximum amount of suggestions is exceeded. See [demo](https://kazanexpress.github.io/vue-simple-suggest/). |
